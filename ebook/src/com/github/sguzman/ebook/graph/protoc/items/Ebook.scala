...
final case class Ebook(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      var __size = 0
      if (date != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(1, date) }
      if (img != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, img) }
      if (desc != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(3, desc) }
      if (id != 0) { __size += _root_.com.google.protobuf.CodedOutputStream.computeUInt32Size(4, id) }
      ...
      categories.foreach(categories => __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(6, categories))
      ...
      if (prev != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(8, prev) }
      if (next != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(9, next) }
      __size
    }
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.scalapb.descriptors.PString(date)
        case 2 => _root_.scalapb.descriptors.PString(img)
        case 3 => _root_.scalapb.descriptors.PString(desc)
        case 4 => _root_.scalapb.descriptors.PInt(id)
        case 5 => detail.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 6 => _root_.scalapb.descriptors.PRepeated(categories.map(_root_.scalapb.descriptors.PString)(_root_.scala.collection.breakOut))
        case 7 => _root_.scalapb.descriptors.PRepeated(links.map(_.toPMessage)(_root_.scala.collection.breakOut))
        case 8 => _root_.scalapb.descriptors.PString(prev)
        case 9 => _root_.scalapb.descriptors.PString(next)
      }
    }
...
object Ebook extends scalapb.GeneratedMessageCompanion[com.github.sguzman.ebook.graph.protoc.items.Ebook] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.github.sguzman.ebook.graph.protoc.items.Ebook = {
    ...
    com.github.sguzman.ebook.graph.protoc.items.Ebook(
      ...
      __fieldsMap.get(__fields.get(4)).asInstanceOf[scala.Option[com.github.sguzman.ebook.graph.protoc.items.Details]],
      __fieldsMap.getOrElse(__fields.get(5), Nil).asInstanceOf[_root_.scala.collection.Seq[_root_.scala.Predef.String]],
      __fieldsMap.getOrElse(__fields.get(6), Nil).asInstanceOf[_root_.scala.collection.Seq[com.github.sguzman.ebook.graph.protoc.items.Link]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.github.sguzman.ebook.graph.protoc.items.Ebook] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.github.sguzman.ebook.graph.protoc.items.Ebook(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).flatMap(_.as[scala.Option[com.github.sguzman.ebook.graph.protoc.items.Details]]),
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.collection.Seq[com.github.sguzman.ebook.graph.protoc.items.Link]]).getOrElse(_root_.scala.collection.Seq.empty),
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 5 => __out = com.github.sguzman.ebook.graph.protoc.items.Details
      case 7 => __out = com.github.sguzman.ebook.graph.protoc.items.Link
    }
    __out
  }
  ...
  final val CATEGORIES_FIELD_NUMBER = 6
  final val LINKS_FIELD_NUMBER = 7
  final val PREV_FIELD_NUMBER = 8
  final val NEXT_FIELD_NUMBER = 9
}
